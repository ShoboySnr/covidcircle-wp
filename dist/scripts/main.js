...
/******/ 	__webpack_require__.p = "/wp-content/themes/covid-circle-wp-theme/dist/";
/******/
...
"use strict";
/* harmony default export */ __webpack_exports__["a"] = (function (uri, key, value) {
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__routes_home__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__routes_about__ = __webpack_require__(11);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__pages_filter__ = __webpack_require__(8);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__util_path__ = __webpack_require__(1);
  ...
  init: function init() {
    ...
    $(document).on('click', '#resize_text_bg button', function() {
      ...
      $('div:not(.njt-nofi-container-content), h1, h2, h3, h4, h5, h6, p, span, li, a, ul, input, textarea, button').not('.njt-nofi-container-content *').each(function() {
        ...
        var height = parseFloat($(this).css('line-height'));
    ...
    $(document).on('change', '#search-form select#resources_types', function() {
      ...
      var $this = $(this).parents('#search-form');
      ...
      var url = $('form#search-form').attr('action') + 'wp-json/covid-circle/v1/categories';
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          if(parsed_data.types !== '') {
              var $category_slug = $this.find('#category_slug');
            ...
            var $category_slug$1 = $this.find('#category_slug');
            $category_slug$1.find('option').remove();
            $category_slug$1.append('<option value="">Category</option>');
          }

          if(parsed_data.subtypes) {
            var $category_slug$2 = $this.find('#sub_category_slug');
            $category_slug$2.find('option').remove();
            $category_slug$2.append('<option value="">Sub Category</option>');
            $.each(parsed_data.subtypes, function(key, value)
            {
              $category_slug$2.append('<option value=' + value.category + ',' + value.slug + '>' + value.name + '</option>');
            });
          } else {
            var $category_slug$3 = $this.find('#sub_category_slug');
            $category_slug$3.find('option').remove();
            $category_slug$3.append('<option value="">Sub Category</option>');
          }
          $('#preloader').hide();
        },
        error: function() {
      ...
      var content_types = $(this).val();
      var name = $(this).attr('name');

      document.location.href = Object(__WEBPACK_IMPORTED_MODULE_2__util_path__["a" /* default */])(window.location.href, name, content_types);
    });
    ...
    $(document).on('click', '#networks-maps svg .group-continent', function() {
      ...
      var network_name = $(this).attr('data-continent');

      var url = $('#networks-maps').attr('data-action') + '/wp-json/covid-circle/v1/networks?network_name=' + network_name;
      ...
      $.ajax({
        ...
        success: function(data) {
          ...
          if(parsed_data.regions != '') {
            ...
            var $add_regions_select = $('#add-regions-select');
            ...
            var $add_regions$1 = $('#add-regions');
            $add_regions$1.find('button').remove();
            $add_regions$1.html('<p class="no-network-found">No regions found.</p>');
            var $add_regions_select$1 = $('#add-regions-select');
            $add_regions_select$1.find('option').remove();
            $add_regions_select$1.append('<option value="">No regions found </option>');
          }
          if(parsed_data.contents != '') {
            var $regions_container = $('#regions-container');
            $regions_container.find('.items-container').remove();
            $.each(parsed_data.contents, function(key, value)
            {
              var link = value.link ? value.link : {url: '', title: '', target: ''};

              var $return_text = '<div class="items-container">' +
            '<div class="item-bg">' +
            ...
            var $regions_container$1 = $('#regions-container');
            $regions_container$1.find('.items-container').remove();
            $regions_container$1.html('<div class="text-center w-full no-network-found"><p>No Network found in this region</p>');
          }
          $('#preloader').hide();
        },
        error: function() {
    ...
    $(document).on('click', '#regions-bg .add-regions button', function() {
      ...
      var network_name = $('#networks-maps svg .active').attr('data-continent') ? $('#networks-maps svg .active').attr('data-continent') : '';

      var url = $('#networks-maps').attr('data-action') + '/wp-json/covid-circle/v1/regions?region_name=' + region_name + '&network_name=' + network_name;
    ...
    $(document).on('change', '#regions-bg .filter-regions select', function() {
      ...
      $(this).addClass('active');
      var region_name = $(this).val();
      var network_name = $('#networks-maps svg .active').attr('data-continent');
...
"use strict";
/* WEBPACK VAR INJECTION */(function($) {/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__util_path__ = __webpack_require__(1);
...
$(document).on('click', '#resources-hub .resources-filter button', function(event) {
  event.preventDefault();
  var resources_types = $(this).val();
  var name = $(this).attr('name');

  document.location.href = Object(__WEBPACK_IMPORTED_MODULE_0__util_path__["a" /* default */])(window.location.href, name, resources_types);
});
...
$(document).on('change', '#resources-hub .resources-filter select', function(event) {
  ...
  return document.location.href = Object(__WEBPACK_IMPORTED_MODULE_0__util_path__["a" /* default */])(window.location.href, name, resources_types);
});
...
$(document).on('click', '#resources-hub .checkbox-group', function(event) {
  ...
  var value = resources_categories.join(',');
  var name = $(this).find('input[type=checkbox]').attr('name');

  document.location.href = Object(__WEBPACK_IMPORTED_MODULE_0__util_path__["a" /* default */])(window.location.href, name, value);
});
...
$(document).on('change', '#post-filter .all-categories select', function(event) {
  ...
  document.location.href = Object(__WEBPACK_IMPORTED_MODULE_0__util_path__["a" /* default */])(window.location.href, name, categories);
});
...
$(document).on('click', '#notibar button.hide-close-button', function() {
  ...
  var show_notice = __WEBPACK_IMPORTED_MODULE_1_js_cookie___default.a.get('show_notibar');
  if(show_notice === undefined) {
    __WEBPACK_IMPORTED_MODULE_1_js_cookie___default.a.set('show_notibar', true, { expires: 365 });
  }
});

$(window).on('load', function() {
  var show_notibar = __WEBPACK_IMPORTED_MODULE_1_js_cookie___default.a.get('show_notibar');
  if (show_notibar) {
...
$(document).on('click', 'button#enable-accessibility', function (event) {
  ...
  setTimeout(function() {
    __WEBPACK_IMPORTED_MODULE_1_js_cookie___default.a.remove('show_notibar');
...
function disable_carousel() {
  var owl = $('#news-and-events .owl-carousel, #resources .owl-carousel');
...
/* WEBPACK VAR INJECTION */(function($) {/* harmony default export */ __webpack_exports__["a"] = ({
  init: function init() {
    ...
    $(document).ready(function(){
      var owl = $('#slide-shows .owl-carousel').owlCarousel({
        loop: true,
        responsiveClass: true,
        items: 1,
        animateOut: 'fadeOut',
